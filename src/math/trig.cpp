...
static const int16_t ATAN2_LUT[65] = {
	0,	 5,	  10,  15,	20,	 25,  30,  35,	40,	 45,  50,  55,	60,	 65,  70,  74,	79,	 84,  88,  93,	97,	 102,
	106, 110, 115, 119, 123, 127, 131, 135, 139, 143, 147, 151, 154, 158, 161, 165, 168, 171, 175, 178, 181, 184,
	187, 190, 193, 196, 198, 201, 204, 206, 209, 211, 214, 216, 218, 221, 223, 225, 227, 229, 231, 233,
...
static int16_t atan_first_octant(int32_t num, int32_t den) {
	if (den == 0) {
		return 256; // 45°, shouldn't happen if called correctly
	}
