...
psyqo::SPU::ChannelPlaybackConfig SoundManager::CreatePlaybackConfig(const VagEntry* vag, uint16_t volume,
																	 uint32_t adsr) {
...
psyqo::SPU::ChannelPlaybackConfig SoundManager::CreatePlaybackConfig(const VagEntry* vag, uint16_t volumeL,
	...
	return psyqo::SPU::ChannelPlaybackConfig{pitch, volumeL, volumeR, adsr};
}
