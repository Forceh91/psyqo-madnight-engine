...
void Camera::SetRotationMatrix(void) {
	...
	psyqo::GteMath::multiplyMatrix33(rotationMatrixY, rotationMatrixX, &rotationMatrixY);
	psyqo::GteMath::multiplyMatrix33(rotationMatrixY, rotationMatrixZ, &rotationMatrixY);
