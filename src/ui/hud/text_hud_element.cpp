...
void TextHUDElement::Render(const psyqo::Rect& parentRect) { Render(parentRect, nullptr); }
...
void TextHUDElement::Render(const psyqo::Rect& parentRect, psyqo::Font<100>* fallbackFont) {
	...
	psyqo::Vertex posInParent = {static_cast<int16_t>(parentRect.pos.x + m_rect.pos.x),
